...
public class ImagePicker: RxMediaPickerDelegate {
    ...
    public func pickImageWith(title: String, message: String, completion :@escaping (_ image: UIImage) -> Void) {
	...
	public func dismiss(picker: UIImagePickerController) {
		picker.dismiss(animated: true, completion: nil)
	}

	public func present(picker: UIImagePickerController) {
