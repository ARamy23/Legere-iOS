...
public typealias TokenTransformer = (_ range: Range<String.Index>) -> SyntaxToken
...
extension RegexLexer {
	...
	public func getSavannaTokens(input: String) -> [SyntaxToken] {
...
extension RegexLexer {
	...
	func generateKeywordTokens(_ generator: KeywordTokenGenerator, source: String) -> [SyntaxToken] {
	...
	public func generateRegexTokens(_ generator: RegexTokenGenerator, source: String) -> [SyntaxToken] {
